...
public class AphorismBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            if (statisticService.isRequestForStatistic(update)) {
                responseMessage = statisticService.getStatistic(messageText);
                ...
                sendPhoto(sendPhoto);
                statisticService.addStat(new Entry(userId.toString(), responseMessage));
            }
